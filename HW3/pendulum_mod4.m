function [period,sol,kinetic,potential, Etot] = pendulum_mod4(omega0,gamma,omega,theta0,thetad0,grph) 
...
N = 1000;%ode 45 solve me 10 periods
...
[t,w] = ode45(@proj,tspan,r0,opts,g,R,gamma,omega); %spits back in @proj thetadot and thetadotdot
sol = [t,w];
...
function rdot = proj(t,r,g,R,gamma,omega)
    rdot = [r(2); cos(omega*t)-gamma.*r(2)-g/R*sin(r(1))]; %thetadot and thetadotdot, semicolon makes it a column vector
end
